...
//        return NoOpPasswordEncoder.getInstance();
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST,"/v1/supplier/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.PUT,"/v1/supplier/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.DELETE,"/v1/supplier/**").hasRole("ADMIN")
